  ...
  return user ? (
    <div className='max-w-4xl mx-auto p-6 space-y-6'>
      <div className='bg-white shadow rounded p-6 flex flex-col items-center text-center'>
        <img src={userData.avatarUrl} alt='avatar' className='w-24 h-24 rounded-full mb-4' />
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        <Link href='/mypage/novels' className='bg-white shadow rounded p-4 flex flex-col items-center hover:bg-gray-50'>
          <div className='text-3xl'>📚</div>
          <h2 className='text-lg font-semibold'>小説管理</h2>
          <p className='text-gray-500'>{userData.novelCount}件</p>
        </Link>

        <Link href='/mypage/characters' className='bg-white shadow rounded p-4 flex flex-col items-center hover:bg-gray-50'>
          <div className='text-3xl'>🧑‍🤝‍🧑</div>
          <h2 className='text-lg font-semibold'>キャラクター管理</h2>
          <p className='text-gray-500'>{userData.characterCount}件</p>
        </Link>

        <Link href='/mypage/worlds' className='bg-white shadow rounded p-4 flex flex-col items-center hover:bg-gray-50'>
          <div className='text-3xl'>🌍</div>
