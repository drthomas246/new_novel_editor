      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
        {characters.map((char: any) => (
          <div key={char.id} className='bg-white shadow rounded p-4 space-y-2'>
            <img src={char.imageUrl} alt='character' className='w-full h-64 object-contain rounded' />
            ...
            <div className='flex flex-wrap gap-2'>
              ...
              <Button size='sm' className='bg-red-600 hover:bg-red-700' onClick={() => handleDelete(char.id)}>
                削除
              </Button>
