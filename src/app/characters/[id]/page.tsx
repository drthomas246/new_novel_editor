...
export default function CharacterDetailPage() {
  ...
  return (
    <div className='max-w-3xl mx-auto p-6 space-y-6'>
      <Link href={`/user/${userId}/characters`} className='text-blue-600 hover:underline'>
        ← 著者のキャラクター一覧に戻る
      </Link>

      <div className='bg-white shadow rounded p-4 space-y-4 text-center'>
        <img src={character.imageUrl} alt='character' className='w-full h-64 object-contain rounded' />
      ...
      <div className='bg-white shadow rounded p-4'>
        <h2 className='text-xl font-semibold mb-4 text-center'>性格診断チャート</h2>
        <div className='h-64'>
